...
const _messages = <KailoMessageKey, (String, String)>{
  ...
  KailoMessageKey.tasksCancelRequest: ('Request cancellation', '请求取消'),
  KailoMessageKey.tasksConfirmCancel: (
  ...
  KailoMessageKey.tasksCancelSubmitted: (
  ...
  KailoMessageKey.tasksCancelUnknown: (
  ...
  KailoMessageKey.tasksCancelSendAgain: ('Resend same request', '重发同一次请求'),
  ...
  KailoMessageKey.tasksStatusCancelRequestAccepted: (
